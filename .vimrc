...
if has("cscope")
    ...
    " h map-which-keys
    " h map-alt-keys
    nmap <F1> :cs find g <C-R>=expand("<cword>")<CR><CR>:QFix2<CR>
    nmap <F2> :cs find s <C-R>=expand("<cword>")<CR><CR>:QFix2<CR>
    nmap <F3> :cs find c <C-R>=expand("<cword>")<CR><CR>:QFix2<CR>
    nmap <F4> :cs find d <C-R>=expand("<cword>")<CR><CR>:QFix2<CR>
    nmap <F5> :cs find t <C-R>=expand("<cword>")<CR><CR>:QFix2<CR>
    nmap <F6> :cs find e <C-R>=expand("<cword>")<CR><CR>:QFix2<CR>
    nmap <F7> :cs find f <C-R>=expand("<cfile>")<CR><CR>:QFix2<CR>
    nmap <F8> :cs find i ^<C-R>=expand("<cfile>")<CR>$<CR>:QFix2<CR>
...
set enc=utf8                                                               " Set UTF-8 encoding
set fenc=utf8
...
" With this addition, copied text from vim can be pasted by CTRL+V and copied text from CTRL+C can be pasted into vim with ‘p’.V
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Insert paranthesis and quotation marks automaticallly
" inoremap ( ()<esc>i
" inoremap " ""<esc>i
